...
Todo el historial de cambios de este proyecto se registrará aquí, siguiendo el estándar estricto de [Conventional Commits] y vinculado a los identificadores del plan de desarrollo para garantizar la trazabilidad por evidencias.
